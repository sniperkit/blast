...
type StartSupervisorCmdOpts struct {
	//configFile string
...
var defaultStartSupervisorCmdOpts = StartSupervisorCmdOpts{
	//configFile: "",
...
var startSupervisorCmdOpts = StartSupervisorCmdOpts{
	//configFile: defaultStartSupervisorCmdOpts.configFile,

	logFormat: defaultStartSupervisorCmdOpts.logFormat,
	logOutput: defaultStartSupervisorCmdOpts.logOutput,
	logLevel:  defaultStartSupervisorCmdOpts.logLevel,

	grpcListenAddress: defaultStartSupervisorCmdOpts.grpcListenAddress,

	supervisorConfigFile: defaultStartSupervisorCmdOpts.supervisorConfigFile,
}

var startSupervisorCmd = &cobra.Command{
	Use:   "supervisor",
	Short: "start supervisor",
	Long:  `The start supervisor command starts the Blast supervisor.`,
